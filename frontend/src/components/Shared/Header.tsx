...
const Header:React.FC = () => {
  return (
    <header>
        <nav className="navbar bg-base-200 rounded-md shadow-md">
            ...
            <div className="flex-1">
              <a href="/" className="btn rounded-2xl shadow-none border-secondary">
            ...
            <label htmlFor="my-drawer" className="btn shadow-none ">
